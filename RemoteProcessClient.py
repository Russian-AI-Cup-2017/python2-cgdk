...
class RemoteProcessClient:
    ...
    def read_facilities(self):
        ...
        facilities = [self.read_facility() for _ in xrange(facility_count)]
    ...
    def read_games(self):
        ...
        return [self.read_game() for _ in xrange(game_count)]
    ...
    def read_players(self):
        ...
        players = [self.read_player() for _ in xrange(player_count)]
    ...
    def read_player_contexts(self):
        ...
        return [self.read_player_context() for _ in xrange(player_context_count)]
    ...
    def read_vehicles(self):
        ...
        return [self.read_vehicle() for _ in xrange(vehicle_count)]
    ...
    def read_vehicle_updates(self):
        ...
        return [self.read_vehicle_update() for _ in xrange(vehicle_update_count)]
    ...
    def read_worlds(self):
        ...
        return [self.read_world() for _ in xrange(world_count)]
    ...
    def read_enums(self, enum_class):
        count = self.read_int()
        return None if count < 0 else [self.read_enum(enum_class) for _ in xrange(count)]

    def read_enums_2d(self, enum_class):
        count = self.read_int()
        return None if count < 0 else [self.read_enums(enum_class) for _ in xrange(count)]
    ...
    def read_ints_2d(self):
        count = self.read_int()
        return None if count < 0 else [self.read_ints() for _ in xrange(count)]
